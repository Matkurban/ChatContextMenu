...
import androidx.compose.ui.unit.dp
import com.matkurban.chatcontextmenu.geometry.maxCornerRadiusPx
import com.matkurban.chatcontextmenu.layout.FloatRect
import com.matkurban.chatcontextmenu.layout.HorizontalMenuLayoutInput
import com.matkurban.chatcontextmenu.layout.VerticalMenuLayoutInput
import com.matkurban.chatcontextmenu.layout.calculateHorizontalMenuLayout
import com.matkurban.chatcontextmenu.layout.calculateVerticalMenuLayout
            ...
            AnimatedMenuLayer(
                ...
                Box(
                    ...
                    when (config.axis) {
                        MenuAxis.Vertical -> {
                            val result =
                                layoutResult as com.matkurban.chatcontextmenu.layout.VerticalMenuLayoutResult
                            MenuSurface(
                                config = config,
                                onDismiss = requestDismiss,
                                menuContent = menuContent,
                        ...
                        MenuAxis.Horizontal -> {
                            val result =
                                layoutResult as com.matkurban.chatcontextmenu.layout.HorizontalMenuLayoutResult
                            MenuSurface(
                                config = config,
                                onDismiss = requestDismiss,
                                menuContent = menuContent,
